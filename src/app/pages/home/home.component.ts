  ...
  routeStops: RouteStop[] = [
    {
      ...
      desc: 'Đang đồng hành cùng NF OOH trên toàn quốc',
      value: '120',
    },
    {
      code: '02',
      title: 'Nhân sự vận hành',
      desc: 'Đội thi công, thiết kế và giám sát hiện trường',
      value: '85',
    },
    {
      code: '03',
      title: 'Chiến dịch đã triển khai',
      desc: 'Từ billboard đơn lẻ đến mạng lưới toàn quốc',
      value: '540',
    },
    {
      code: '04',
      title: 'Điểm quảng cáo đang quản lý',
      desc: 'Billboard, xe buýt, nhà chờ và màn hình LED',
      value: '860',
    },
  ];
...
serviceCards: ServiceCard[] = [
  ...
  // Ảnh minh hoạ khu vực "Về chúng tôi"
  ...
  newsPosts: NewsPost[] = [
    {
      ...
      excerpt:
        'Quảng cáo ngoài trời không biến mất trước digital — nó thay đổi vai trò và trở thành điểm chạm không thể bỏ qua.',
    },
    {
      date: '02 Th09',
      title: 'Cách chọn vị trí billboard hiệu quả cho ngành bán lẻ',
      excerpt:
        'Mật độ giao thông, góc nhìn và thời gian dừng đèn đỏ — ba yếu tố quyết định hiệu quả một vị trí quảng cáo.',
    },
    {
      date: '18 Th09',
      title: 'Thi công gian hàng triển lãm: những lỗi thường gặp',
      excerpt:
        'Từ vật liệu chống cháy đến thời gian tháo dỡ — checklist giúp gian hàng của bạn vận hành trơn tru.',
    },
    {
      date: '05 Th10',
      title: 'Đo lường hiệu quả OOH bằng dữ liệu lưu lượng',
      excerpt:
        'Không chỉ dựa vào vị trí đẹp — dữ liệu di chuyển thực tế giúp chứng minh hiệu quả đầu tư rõ ràng hơn.',
    },
  ];
  ...
  ngAfterViewInit(): void {
    this.slideSubscription = interval(2000).subscribe(() => {
      this.activeSlideIndex =
        (this.activeSlideIndex + 1) % this.billboardSlides.length;
